...
export default function init(shadow) {
    ...
    switchClima.addEventListener("change", () => {
        if (switchClima === null || switchClima === void 0 ? void 0 : switchClima.checked) {
    ...
    clearMessagesButton === null || clearMessagesButton === void 0 ? void 0 : clearMessagesButton.addEventListener("click", () => {
        var _a;
        (_a = chatService.currentSession) === null || _a === void 0 ? void 0 : _a.clearMessages();
        chatMessages.innerHTML = "";
    });
    //configuracion del tool modal
    toolBtn === null || toolBtn === void 0 ? void 0 : toolBtn.addEventListener("click", () => {
        toolModal === null || toolModal === void 0 ? void 0 : toolModal.classList.add("active");
    });
    closeToolBtn === null || closeToolBtn === void 0 ? void 0 : closeToolBtn.addEventListener("click", () => {
        toolModal === null || toolModal === void 0 ? void 0 : toolModal.classList.remove("active");
    });
    ...
    function renderPersistencedHistory() {
        var _a;
        let history = JSON.parse((_a = localStorage.getItem("messages")) !== null && _a !== void 0 ? _a : "");
        if (!history) {
            return;
        }
    ...
    switchClima.checked = JSON.parse(localStorage.getItem("isWeatherToolActive") || "false");
